...
<table align="center" cellpadding="0" cellspacing="0" style="width: 700px" border="0">
		...
		<td style="width:290px" valign="top">
		  <table align="center" cellpadding="0" cellspacing="0" style="width: 290px" class="auto-style1">
			...
			<tr>
				...
				<td style="width:10px">&nbsp;</td>
				<td style="width:200px"><h5><?php print(iconv("WINDOWS-1252", "utf-8", $rs['EMPRESA'])); ?></h5></td>
			</tr>
			...
			<tr>
				...
				<td style="width:10px">&nbsp;</td>
				<td style="width:100px"><h5><?php print(iconv("WINDOWS-1252", "utf-8", $rs['FH_INICIO'])); ?></h5></td>
			</tr>

			<tr>
				<td style="width:180px" align="right"><h5>Fh Cierre:</h5></td>
				<td style="width:10px">&nbsp;</td>
				<td style="width:100px"><h5><?php print(iconv("WINDOWS-1252", "utf-8", $rs['FH_CIERRE'])); ?></h5></td>
			</tr>
		  </table>
		</td>
		...
		<td style="width:290px" valign="top">
		  <table align="center" cellpadding="0" cellspacing="0" style="width: 290px" class="auto-style2">
			...
			<tr>
				...
				<td style="width:10px">&nbsp;</td>
				<td style="width:100px" align="right"><h5 style="color:green; font-weight:bold;" ><?php print(iconv("WINDOWS-1252", "utf-8", $rs['CUANTIFICACION'])); ?></h5></td>
			</tr>
	...
	?>
		<td colspan="3">
			<table class="table table-striped table-bordered" cellpadding="0" cellspacing="0" style="width: 100%">
				<tr>
					<th>Trabajador</th>
					<th>Puesto</th>
					<th>FH_Ingreso</th>
				...
				<?php while($rs3 = $cs->fetch()) { ?>
						<tr>
							<td><?php echo $rs3['Trabajadores'] ?></td>
							<td><?php echo $rs3['Puesto'] ?></td>
							<td><?php echo $rs3['Fecha_Ing'] ?></td>
							<td><?php echo $rs3['Fecha_Baj'] ?></td>
						</tr>
				<?php } ?>
			</table>
		</td>
