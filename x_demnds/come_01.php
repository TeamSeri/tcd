...
<table align="center" cellpadding="0" cellspacing="0" style="width: 700px;margin-top: 50px;">
	<tr>
		<td><h4>Demandas - Comentarios</h4></td>
	</tr>
</table>
						...
						<tr>
							...
							<td class="auto-style1"><center>
 							  <map id="ImgMapA<?php print(strval($x)); ?>" name="ImgMapA<?php print(strval($x)); ?>">
								...
								<area alt="Comentarios" coords="12, 12, 12" href="come_02.php?id=<?php print(strval($rs['NU_FOLIO'])); ?>" shape="circle" />
								<?php }else{ ?>
								<area alt="Comentarios" coords="12, 12, 12" href="come_03.php?id=<?php print(strval($rs['NU_FOLIO'])); ?>" shape="circle" />
								<?php } ?>
							  </map>
 							  <img alt="Comentarios" height="24" src="../imagenes/icono_editar.png" usemap="#ImgMapA<?php print(strval($x)); ?>" width="24" /></center>
							</td>
						</tr>
					<?php } ?>
