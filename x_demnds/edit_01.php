...
<table align="center" cellpadding="0" cellspacing="0" style="width: 700px">
	<tr>
		<td style="width:30px"><img src="../imagenes/icono_ayuda.png" width="20x" height="20px" onclick="MuestraAyuda(2)" data-toggle="modal" data-target="#ModalAyuda" /></td>
			...
			<table id="myTable" class="table table-bordered" cellspacing="0" width="100%">
				<thead>
					<tr>
						...
						<?php if($_SESSION['rh_legal_perfil']==1) { ?>
							<th><center><small><small>&nbsp;</small></small></center></th>
						<?php } ?>
					</tr>
				</thead>
					...
					<tr>
						...
						<td class="auto-style1"><center>
							  ...
							  <?php if ($rs['NU_FOLIO'] < 2000){ ?>
									<area alt="Editar Demanda" coords="12, 12, 12" href="edit_02.php?id=<?php print(strval($rs['NU_FOLIO'])); ?>" shape="circle" />
						  <?php }else{ ?>
									<area alt="Editar Demanda" coords="12, 12, 12" href="edit_04.php?id=<?php print(strval($rs['NU_FOLIO'])); ?>" shape="circle" />
							    <?php } ?>
						  </map>
							  <img alt="Editar Demanda" height="24" src="../imagenes/icono_editar.png" usemap="#ImgMapA<?php print(strval($x)); ?>" width="24" /></center>
						</td>
						<?php if($_SESSION['rh_legal_perfil']==1) { ?>
						<td class="auto-style1">
							<center>
							  	<map id="ImgMapBB<?php print(strval($x)); ?>" name="ImgMapBB<?php print(strval($x)); ?>">
									<?php if ($rs['NU_FOLIO'] < 2000){ ?>
											<area alt="Eliminar Demanda" coords="12, 12, 12" href="elim_01.php?id=<?php print(strval($rs['NU_FOLIO'])); ?>" shape="circle" />
									<?php }else{ ?>
											<area alt="Eliminar Demanda" coords="12, 12, 12" href="elim_02.php?id=<?php print(strval($rs['NU_FOLIO'])); ?>" shape="circle" />
									<?php } ?>
				  				</map>

							  	<img alt="Eliminar Demanda" height="24" src="../imagenes/icono_eliminar.png" usemap="#ImgMapBB<?php print(strval($x)); ?>" width="24" />
						  	</center>
						</td>
						<?php } ?>
					</tr>
