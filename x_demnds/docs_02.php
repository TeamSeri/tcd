...
<?php
    ...
    if(isset($_REQUEST['doit']))
      {
         ...
         $target_file = str_ireplace(' ', '', "..\doctos\ " . $file_name);
    ...
    $qry = " sp_Demandas_Consulta_Demandas_Documentos " . $_REQUEST['id'];
    $csD = $db->prepare($qry);
    $csD->execute();
    $rsD = $csD->fetch();
...
<form name="myForm" enctype="multipart/form-data" method="post" action="docs_02.php?doit=1&id=<?php print($_REQUEST['id']); ?>">
