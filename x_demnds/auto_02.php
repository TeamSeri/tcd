    ...
    if(isset($_REQUEST['st']))
      {
         ...
         $qry = " insert into T003_BITACORA "
              ...
              . " values (".$_SESSION['rh_legal_idempresa'].", 2        , " . $_REQUEST['id'] . ", " .  $_REQUEST['et'] . ",  " . $_REQUEST['st'] . ", " . $_SESSION['rh_legal_usuario'] . ") ";
...
<table align="center" cellpadding="0" cellspacing="0" style="width: 700px; height: 100px">
	<tr>
		<td style="width: 360px; height: 50px" valign="top">
		   <h3 class="text-center">La fase <?php print(iconv("WINDOWS-1252", "utf-8",$fase)); ?> se marcó como autorizada.</h3>
		  ...
		  <table align="center" cellpadding="0" cellspacing="0" style="width: 350px" class="auto-style3">
			...
			<tr>
				...
				<map id="ImgMap02" name="ImgMap02">
					<area alt="" coords="13, 13, 13" href="auto_02.php?st=1&et=<?php print($_REQUEST['et']) ?>&id=<?php print($_REQUEST['id']) ?>" shape="circle" />
				</map>
				<img alt="Exitosa" height="26" longdesc="Fase Exitosa" src="../imagenes/fase_<?php print($icono); ?>.png" width="26" usemap="#ImgMap02" /></td>
