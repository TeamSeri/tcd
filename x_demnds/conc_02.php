		  ...
		  <table align="center" cellpadding="0" cellspacing="0" style="width: 350px" class="auto-style3">
			...
			<tr>
				...
				<map id="ImgMap01" name="ImgMap01">
					<area alt="" coords="13, 13, 13" href="conc_02.php?st=0&et=<?php print($_REQUEST['et']) ?>&id=<?php print($_REQUEST['id']) ?>" shape="circle" />
				</map>
				...
				<map id="ImgMap02" name="ImgMap02">
					<area alt="" coords="13, 13, 13" href="conc_02.php?st=1&et=<?php print($_REQUEST['et']) ?>&id=<?php print($_REQUEST['id']) ?>" shape="circle" />
				</map>
				...
				<map id="ImgMap03" name="ImgMap03">
					<area alt="" coords="13, 13, 13" href="conc_02.php?st=2&et=<?php print($_REQUEST['et']) ?>&id=<?php print($_REQUEST['id']) ?>" shape="circle" />
				</map>
